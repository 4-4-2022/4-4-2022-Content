...
> This document provides a list of the required technologies for anyone who is training on the Java/Mulesoft track. It details why each technology is required and provides some step-by-step instructions on how to install and configure the technologies. This guide also walks you through any needed environment setup.
...
Before installing any of the below software, please see the hardware requirements for running Mule applications locally and make sure that your environment matches these requirements: [Mule Hardware and Software Requirements](https://docs.mulesoft.com/mule-runtime/4.4/hardware-and-software-requirements).
...
- **Anypoint Studio**: We will be using Anypoint Studio as our IDE for building Mule applications.
...
In order to use Scoop, you'll first have to install it. This installation requires that you have PowerShell 5 or later. Please note that you will be able to quickly install most of the software using this method but that some of the required technologies must be manually downloaded from the vendors' sites.
...
### Step 10: Apache ActiveMQ

### Step 11: Install PostgreSQL (Optional)
...
### Step 4: Install Anypoint Studio

In order to download Anypoint Studio, go the [Mulesoft's official site](https://www.mulesoft.com/platform/studio). Once there, you should see the following:

![Anypoint Download Site](./images/anypoint.PNG)

Click the "Download Studio" link. You should be taken to the following page:

![Download Anypoint](./images/download-anypoint.PNG)

Select your operating system and agree to Salesforce's license agreement. Then click "Download".
...
### Step 9: Install Apache ActiveMQ

In order to download ActiveMQ, please visit [Apache's official ActiveMQ website](https://activemq.apache.org/components/classic/download/).

Once you've navigated to the site, please choose the download link that is appropriate for your operating system:

![Image of ActiveMQ download options](./images/activemq.PNG)

After you download ActiveMQ, you don't need to do anything else with the downloaded files, though feel free to use ActiveMQ's documentation to explore the technology.
